...
import com.architecture.goodscenter.event.CartAllCheckedEvent
import com.architecture.goodscenter.event.UpdateCartSizeEvent
import com.architecture.goodscenter.event.UpdateTotalPriceEvent
import com.architecture.goodscenter.injection.component.DaggerCartComponent
...
//             .mapTo(cartIdList) { it.id } 就是将it.id都放到cartIdList中。
    ...
    private fun updateTotalPrice() {
        mTotalPrice = mAdapter.dataList
                ...
                .map { it.goodsCount * it.goodsPrice }//选中的获取每个商品的价格
                .sum()//将所有价格去和
